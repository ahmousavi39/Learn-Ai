...
export declare class AppStoreServerAPI {
     ...
     */
    sendConsumptionInformation(transactionId: string, request: ConsumptionRequest): Promise<any>;
    /**
